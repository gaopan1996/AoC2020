...
Create list of 25 values from input. Loop through 25 list to try and find the difference is in the list. Exit when difference isn't in list.
"""
value = 0
count = 0
        ...
        if count < 25:
            ...
            for index in range(len(xmas)):
                if (potentialSum - xmas[index]) in xmas:
                    print(f'Found pair ({xmas[index]}, {potentialSum - xmas[index]}) for {potentialSum}')
                    xmas = xmas[1:]
