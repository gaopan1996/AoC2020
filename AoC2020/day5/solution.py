...
Change line into binary string and then convert to a decimal int. Calculate SID and get the max.
"""
def calculate_sid(r, c):
   return r*8 + c
...
with open('input.txt', "r") as input_file:
    ...
    for line in arr:
        ...
        sid = calculate_sid(row, column)
        if sid > maxSid:
            maxSid = sid
        print(f'{line} = ({row}, {column}, {sid})')
print(f"Solution: {maxSid}")
